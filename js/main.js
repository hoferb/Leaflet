...
var stadia_as = L.tileLayer('https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}{r}.{ext}', {
	minZoom: 0,
	maxZoom: 20,
...
var baseMaps = {
	...
	"Stadia Alidade smooth": stadia_as,
	"Stadia Alidade smooth dark": stadia_asd
}
